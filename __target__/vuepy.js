// Transcrypt'ed from Python, 2020-12-29 18:07:23
...
export var VuePy =  __class__ ('VuePy', [object], {
	...
	get __init__ () {return __get__ (this, function (self) {
		...
		for (var elem of dir (self)) {
			if (!__in__ (elem, ['__bases__', '__class__', '__init__', '__metaclass__', '__module__', '__name__', '__new__', 'methods', 'computed', 'watch', 'mount', 'deploy', '__deployed__'])) {
				...
				else if (__in__ (elem, self.compute)) {
